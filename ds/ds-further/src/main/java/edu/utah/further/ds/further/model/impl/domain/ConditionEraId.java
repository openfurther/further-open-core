...
@Implementation
@Embeddable
public class ConditionEraId implements Serializable,
		Comparable<ConditionEraId>, HasSettableIdentifier<Long>,
		HasDatasetIdentifier<String>
{

	// ========================= CONSTANTS ===================================

	private static final long serialVersionUID = -794502479743965132L;

	// ========================= FIELDS ===================================

	@Column(name = "fcondition_era_id", nullable = false)
	private Long id;
	 ...
	 * 
	 * @see
	 * edu.utah.further.core.api.discrete.HasDatasetIdentifier#setQueryId(java.lang.Comparable
	 * )
	 */
	@Override
	...
	public boolean equals(final Object obj)
	{
		...
		final ConditionEraId that = (ConditionEraId) obj;
