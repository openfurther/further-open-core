...
/**
 * An embeddable encounter id to handle composite keys.
 * <p>
 * -----------------------------------------------------------------------------------<br>
		...
		HasDatasetIdentifier<String>
{
	...
	private static final long serialVersionUID = -7945024798159885132L;

	// ========================= FIELDS ===================================

	@Column(name = "fencounter_id", nullable = false)
	private Long id;
	 ...
	 */
	@Override
	public int compareTo(final EncounterId other)
	{
	...
	public boolean equals(final Object obj)
	{
		...
		final EncounterId that = (EncounterId) obj;
