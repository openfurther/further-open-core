...
@Implementation
@Embeddable
public class ObservationPeriodId implements Serializable,
		Comparable<ObservationPeriodId>, HasSettableIdentifier<Long>,
		HasDatasetIdentifier<Long>
{
	// ========================= CONSTANTS ===================================

	private static final long serialVersionUID = 2947589930422356019L;

	// ========================= FIELDS ===================================

	@Column(name = "fobservation_period_id", nullable = false)
	private Long id;
	 ...
	 */
	@Override
	public int compareTo(final ObservationPeriodId other)
	{
	...
	public boolean equals(final Object obj)
	{
		...
		final ObservationPeriodId that = (ObservationPeriodId) obj;
