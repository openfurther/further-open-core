...
/**
 * An embeddable order id to handle composite keys.
 * <p>
 * -----------------------------------------------------------------------------------<br>
		...
		HasSettableIdentifier<Long>, HasDatasetIdentifier<Long>
{
	...
	private static final long serialVersionUID = -2485323754917256982L;

	// ========================= FIELDS ===================================

	@Column(name = "forder_id", nullable = false)
	private Long id;
	...
	public boolean equals(final Object obj)
	{
		...
		final OrderId that = (OrderId) obj;
