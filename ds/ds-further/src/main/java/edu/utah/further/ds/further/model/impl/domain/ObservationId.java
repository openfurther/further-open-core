...
public class ObservationId implements Serializable,
		Comparable<ObservationId>, HasSettableIdentifier<Long>,
		HasDatasetIdentifier<Long>
{
	// ========================= CONSTANTS ===================================

	private static final long serialVersionUID = 7966310850422356019L;

	// ========================= FIELDS ===================================

	@Column(name = "fobservation_id", nullable = false)
	private Long id;
	 ...
	 */
	@Override
	public int compareTo(final ObservationId other)
	{
	...
	public boolean equals(final Object obj)
	{
		...
		final ObservationId that = (ObservationId) obj;
