...
/**
 * An embeddable provider id to handle composite keys.
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
public class ProviderId implements Serializable,
		Comparable<ProviderId>, HasSettableIdentifier<Long>,
		HasDatasetIdentifier<String>
{
	// ========================= CONSTANTS ===================================

	private static final long serialVersionUID = 374934717253271355L;

	// ========================= FIELDS ===================================

	@Column(name = "fprovider_id", nullable = false)
	private Long id;
	 ...
	 */
	@Override
	public int compareTo(final ProviderId other)
	{
	...
	public boolean equals(final Object obj)
	{
		...
		final ProviderId that = (ProviderId) obj;
