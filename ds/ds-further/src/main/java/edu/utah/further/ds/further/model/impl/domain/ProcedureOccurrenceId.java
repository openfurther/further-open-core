...
@Implementation
@Embeddable
public class ProcedureOccurrenceId implements Serializable,
		Comparable<ProcedureOccurrenceId>, HasSettableIdentifier<Long>,
		HasDatasetIdentifier<Long>
{
	// ========================= CONSTANTS ===================================

	private static final long serialVersionUID = 3242310850424656019L;

	// ========================= FIELDS ===================================

	@Column(name = "fprocedure_id", nullable = false)
	private Long id;
	 ...
	 */
	@Override
	public int compareTo(final ProcedureOccurrenceId other)
	{
	...
	public boolean equals(final Object obj)
	{
		...
		final ProcedureOccurrenceId that = (ProcedureOccurrenceId) obj;
