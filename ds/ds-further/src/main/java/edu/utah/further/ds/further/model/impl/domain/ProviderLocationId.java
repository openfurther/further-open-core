...
public class ProviderLocationId implements Serializable,
		Comparable<ProviderLocationId>, HasSettableIdentifier<Long>,
		HasDatasetIdentifier<Long>
{

	// ========================= CONSTANTS ===================================

	private static final long serialVersionUID = 374693467253291472L;

	// ========================= FIELDS ===================================

	@Column(name = "fprovider_lctn_id", nullable = false)
	private Long id;
	...
	public boolean equals(final Object obj)
	{
		...
		final ProviderLocationId that = (ProviderLocationId) obj;
