 ...
 */
package edu.utah.further.ds.test.schema;
...
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ATTRIBUTE_NAME;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ATTRIBUTE_VALUE;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_EXPECTED_CLASS_PATH;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_IGNORED_ELEMENT;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_IN;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_INPUT_CLASS_PATH;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_OUT;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_PARAM;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_SERVICE_USER_ID;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_SPECIAL_ACTION;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_TARGET_NAMESPACE_ID;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_TEST;
import static edu.utah.further.ds.test.schema.DsTestSchemaConstants.ELEMENT_TRANSFORMER;
 ...
 * @version May 4, 2010
 */
final class XmlTestSuiteBeanDefinitionParser extends AbstractBeanDefinitionParser
{
	// ========================= FIELDS ====================================
