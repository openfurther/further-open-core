 ...
 */
public interface ProviderDimension extends PubliclyCloneable<ProviderDimension>
{

	ProviderDimensionId getId();

	void setId(ProviderDimensionId providerDimensionPK);
	...
	void setProviderBlob(String providerBlob);
