 ...
 */
public interface PatientMapping extends PubliclyCloneable<PatientMapping>
{

	PatientMappingId getId();

	void setId(PatientMappingId patientMappingPK);
	...
	void setPatientIdeStatus(String patientIdeStatus);
