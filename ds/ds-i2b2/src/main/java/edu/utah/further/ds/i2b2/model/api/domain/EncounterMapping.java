 ...
 */
public interface EncounterMapping extends PubliclyCloneable<EncounterMapping>
{

	EncounterMappingId getId();

	BigInteger getEncounterNum();

	void setEncounterNum(BigInteger encounterNum);

	String getPatientIde();

	void setPatientIde(String patientIde);

	String getPatientIdeSource();

	void setPatientIdeSource(String patientIdeSource);

	String getEncounterIdeStatus();

	void setEncounterIdeStatus(String encounterIdeStatus);
