...
/**
 * A function pointer that allows reusing a common abstraction of multiple concept finder
...
interface ConceptFinder
{
	 ...
	 *
	 * @param options
	 *            options containing for example attribute set to retrieve with the
	 *            concept
	 * @param namespaceId
	 ...
	 */
	TranslationResult findConcepts(DtsOptions options, int namespaceId,
			Object... args);
}
