...
/**
 * Spring custom namespace handler for the "dts" schema.
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 */
public final class DtsNamespaceHandler extends NamespaceHandlerSupport
{
	...
	public void init()
	{
		...
		// registerBeanDefinitionParser("aspects", new
		// AspectManagerBeanDefinitionParser());
		registerBeanDefinitionParser(DtsSchemaConstants.ELEMENT_ASPECT,
				new AspectBeanDefinitionParser());
	}
