 ...
 * @version Sep 2, 2010
 */
@Service("codeLineScanner")
public final class CodeLineScanner extends AbstractLineScanner<String>
{
	// ========================= CONSTANTS =================================
	 ...
	 */
	private static final Logger log = getLogger(CodeLineScanner.class);
