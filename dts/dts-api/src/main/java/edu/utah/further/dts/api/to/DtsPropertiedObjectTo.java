...
@DtsEntity
@Api
public interface DtsPropertiedObjectTo extends DtsPropertiedObject
// , CopyableFrom<DtsPropertiedObject, DtsPropertiedObjectTo>
{
	// ========================= METHODS ===================================
	 ...
	 */
	void setProperties(Map<String, DtsProperty> properties);
}