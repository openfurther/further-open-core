...
/**
 * A DTS <code>Synonym</code> transfer object.
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 */
@Api
public interface DtsSynonymTo extends DtsSynonym, DtsAssociationTo
{
	// ========================= METHODS ===================================
	 ...
	 */
	DtsConceptUniqueId getConceptId();
	 ...
	 */
	void setConceptId(DtsConceptUniqueId conceptId);
}