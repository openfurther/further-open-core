...
/**
 * An interface extracted from Apelon DTS API's <code>DTSObject</code>.
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
@DtsEntity
@Api
public interface DtsObject extends DtsData, InNamespace
{
	...
	// * exists.
	// *
	// * @return Apelon DTS object view
	// */
	// DTSObject getAsDTSObject();
