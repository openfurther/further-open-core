...
// ============================
/**
 * Used in adapting a histogram's {@link Map} to a JAXB entity.
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
{ "key", "value" })
@XmlRootElement(namespace = XmlNamespace.FQE, name = HistogramEntryTo.ENTITY_NAME)
public final class HistogramEntryTo implements MutablePublicMapEntry<String, Long>
{
	// ========================= CONSTANTS =================================
	 ...
	 */
	static final String ENTITY_NAME = "entry";
