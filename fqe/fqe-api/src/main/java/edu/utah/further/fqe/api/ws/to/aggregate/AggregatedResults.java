...
import edu.utah.further.fqe.ds.api.domain.HasResultViews;
 ...
 * @version Mar 23, 2011
 */
public interface AggregatedResults extends
		CopyableFrom<AggregatedResults, AggregatedResults>,
		PubliclyCloneable<AggregatedResults>, HasResultViews
{
	// ========================= METHODS ===================================
	 ...
	 * @return
	 */
	void addResult(AggregatedResult value);

	/**
	 * @return
	 */
	Set<AggregatedResult> getResults();

	/**
	 * @param numDataSources
	 */
	void setNumDataSources(int numDataSources);
