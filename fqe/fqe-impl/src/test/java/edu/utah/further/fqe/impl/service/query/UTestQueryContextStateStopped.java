 ...
 */
@UnitTest
public final class UTestQueryContextStateStopped extends QueryContextStateFixture
{
	// ========================= CONSTANTS =================================
	...
	private static final Logger log = getLogger(UTestQueryContextStateStopped.class);
	...
	/**
	 * Get to {@link QueryState#STOPPED} state.
	 */
	@Before
	...
	/**
	 * A unit test of obtaining {@link QueryState#STOPPED}'s permissible transitional
	 * actions.
	 */
	@Test
	public void actionSet()
	{
		assertActionSetEquals(qc, QueryAction.FAIL, QueryAction.START);
	}

	/**
	 * A unit test of {@link QueryState#STOPPED} and its transitional actions.
	 */
	@Test
