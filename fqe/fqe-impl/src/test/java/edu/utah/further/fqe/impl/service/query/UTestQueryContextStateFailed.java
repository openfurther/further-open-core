 ...
 */
@UnitTest
public final class UTestQueryContextStateFailed extends QueryContextStateFixture
{
	// ========================= CONSTANTS =================================
	...
	private static final Logger log = getLogger(UTestQueryContextStateFailed.class);
	...
	/**
	 * Get to {@link QueryState#FAILED} state.
	 */
	@Before
	...
	/**
	 * A unit test of obtaining {@link QueryState#FAILED}'s permissible transitional
	 * actions.
	 */
	@Test
