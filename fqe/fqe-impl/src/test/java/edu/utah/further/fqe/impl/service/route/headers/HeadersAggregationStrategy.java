 ...
 * <p>
 * Also copies the JMS reply headers for Dustin's request-reply solution.
 * -----------------------------------------------------------------------------------<br>
...
public class HeadersAggregationStrategy implements AggregationStrategy
{
	...
	private static final Logger log = getLogger(HeadersAggregationStrategy.class);
	...
	public Exchange aggregate(final Exchange oldExchange, final Exchange newExchange)
	{
		...
		if (oldExchange == null)
		{
			...
			answer.setProperty("org.apache.camel.jms.replyDestination", newExchange
					.getProperty("org.apache.camel.jms.replyDestination"));
			answer.getOut().setMessageId(newExchange.getIn().getMessageId());
		}
		else
		{
