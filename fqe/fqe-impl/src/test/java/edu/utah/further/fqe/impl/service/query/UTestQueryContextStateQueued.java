 ...
 */
@UnitTest
public final class UTestQueryContextStateQueued extends QueryContextStateFixture
{
	// ========================= CONSTANTS =================================
	...
	private static final Logger log = getLogger(UTestQueryContextStateQueued.class);
	...
	/**
	 * Get to {@link QueryState#QUEUED} state.
	 */
	@Before
	...
	/**
	 * A unit test of obtaining {@link QueryState#QUEUED}'s permissible transitional
	 * actions.
	 */
	@Test
	public void actionSet()
	{
		assertActionSetEquals(qc, QueryAction.START, QueryAction.FAIL);
	}

	/**
	 * A unit test of {@link QueryState#QUEUED} and its transitional actions.
	 */
	@Test
