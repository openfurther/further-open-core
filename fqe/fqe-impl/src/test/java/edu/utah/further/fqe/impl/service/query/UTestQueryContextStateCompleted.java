 ...
 */
@UnitTest
public final class UTestQueryContextStateCompleted extends QueryContextStateFixture
{
	// ========================= CONSTANTS =================================
	...
	private static final Logger log = getLogger(UTestQueryContextStateCompleted.class);
	...
	/**
	 * Get to {@link QueryState#COMPLETED} state.
	 */
	@Before
	...
	/**
	 * A unit test of obtaining {@link QueryState#COMPLETED}'s permissible transitional
	 * actions.
	 */
	@Test
	public void actionSet()
	{
		assertActionSetEquals(qc);
	}
