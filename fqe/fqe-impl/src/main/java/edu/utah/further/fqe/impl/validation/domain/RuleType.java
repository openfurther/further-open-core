...
public enum RuleType
{
	...
	@XmlEnumValue("DataTypeRestriction")
	DATA_TYPE_RESTRICTION("DataTypeRestriction"), @XmlEnumValue("ObservationRestriction")
	OBSERVATION_RESTRICTION("ObservationRestriction");
