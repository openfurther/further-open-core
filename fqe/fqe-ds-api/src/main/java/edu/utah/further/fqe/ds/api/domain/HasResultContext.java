 ...
 * @version Mar 30, 2011
 */
public interface HasResultContext
{
	// ========================= METHODS ===================================

	/**
	 * Return the primary result context associated with this query. This is the SUM-type
	 * context, created when {@link #setNumRecords(long)} is invoked.
	 *
	 * @return the default SUM result context
	 */
