...
public final class UTestJaxbPostProcessorPolymorphic
{
	// ========================= CONSTANTS =================================
	 ...
	 */
	private static final Logger log = getLogger(UTestJaxbPostProcessorPolymorphic.class);
	...
	public void stripBodySameClass() throws Exception
	{
		...
		final String expectedBody = "<data><name>Default name</name><description>Default description</description><status>INACTIVE</status></data>";
		testStripBody(rawBody, expectedBody);
	}
	...
	public void stripBodySubClass() throws Exception
	{
		...
		final String expectedBody = "<data xsi:type=\"ns1:dsMetaData\"><name>Default name</name><description>Default description</description><status>INACTIVE</status></data>";
		testStripBody(rawBody, expectedBody);
	}
	...
	private void testStripBody(final String rawBody, final String expectedBody)
	{
		final String transformedBody = JaxbNamespaceStripper.newPolymorphicInstance(
				XmlNamespace.XML_NS1, "data", true).stripNamespace(rawBody);
