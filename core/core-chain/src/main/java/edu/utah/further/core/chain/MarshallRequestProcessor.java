...
/**
 * A request processor that marshal objects into XML or marshals XML into objects.
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 * @version May 26, 2010
 */
public interface MarshallRequestProcessor extends RequestTransformer
{
	// ========================= METHODS ===============================

	/**
	 * Return the schemaAttr property. Supported only by marshallers.
	 *
	 * @return the schemaAttr
	 */
