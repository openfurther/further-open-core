...
/**
 * A parser of the Spring schema "further"'s <code>class</code> element.
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 * @version Aug 27, 2010
 */
final class ClassBeanDefinitionParser extends AbstractSingleBeanDefinitionParser
{
	...
	{
		// Class object are instantiated using a static factory method
		final String pattern = element.getAttribute(CoreSchemaConstants.ATTRIBUTE_VALUE);
		bean.addConstructorArgValue(pattern);
		bean.getRawBeanDefinition().setBeanClass(ClasspathUtil.class);
		bean.setFactoryMethod("loadClass");
	}
}
