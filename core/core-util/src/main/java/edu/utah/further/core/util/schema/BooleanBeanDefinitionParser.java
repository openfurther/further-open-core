...
/**
 * A parser of the Spring schema "further"'s <code>boolean</code> element.
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 * @version Oct 12, 2009
 */
final class BooleanBeanDefinitionParser extends AbstractSingleBeanDefinitionParser
{
	...
	protected void doParse(final Element element, final BeanDefinitionBuilder bean)
	{
		...
		final String pattern = element
				.getAttribute(CoreSchemaConstants.ATTRIBUTE_VALUE);
