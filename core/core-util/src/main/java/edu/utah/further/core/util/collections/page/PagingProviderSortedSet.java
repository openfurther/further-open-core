 ...
 * @version Sep 22, 2010
 */
final class PagingProviderSortedSet extends AbstractPagingProviderIterable<SortedSet<?>>
{
	// ========================= CONSTRUCTORS ==============================
	 ...
	 * @param iterableType
	 */
	PagingProviderSortedSet(final Labeled iterableType)
	{
		super(iterableType);
	}
	 ...
	 */
	@Override
	public Pager<?> newPager(final SortedSet<?> iterable,
