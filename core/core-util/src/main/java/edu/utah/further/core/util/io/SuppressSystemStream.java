...
@Inherited
@Documented
public @interface SuppressSystemStream
{
	/**
	 ...
	 */
	SystemOutputStream stream();

	/**
	 * The logging level to use when redirecting the stream.
	 */
	LogLevel level() default LogLevel.NONE;
}
