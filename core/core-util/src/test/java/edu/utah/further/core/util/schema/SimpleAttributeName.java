...
/**
 * Simple enum type to test Spring enum property conversions.
 * <p>
 * -----------------------------------------------------------------------------------<br>
 ...
 * @version Aug 19, 2010
 */
public enum SimpleAttributeName implements Labeled
{
	 ...
	 */
	private static final String LABEL_PREFIX = SimpleAttributeName.class
			.getCanonicalName() + Strings.PROPERTY_SCOPE_CHAR;
