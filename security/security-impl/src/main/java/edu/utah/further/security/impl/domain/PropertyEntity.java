...
/**
 * A database backed property implementation.
 * 
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
public class PropertyEntity implements Property
{
	 ...
	 */
	private static final long serialVersionUID = -1456104520444836117L;

	@Id
	@GeneratedValue
	@Column(name = "app_prop_id")
	private Long id;

	@Column(name = "prop_nmspc_id")
	private Long namespace;

	@Column(name = "prop_name")
	private String name;

	@Column(name = "prop_dsc")
	 ...
	 */
	@Override
	public void setNamespace(final Long namespace)
	{
	...
	public boolean equals(final Object object)
	{
		...
		final PropertyEntity that = (PropertyEntity) object;
