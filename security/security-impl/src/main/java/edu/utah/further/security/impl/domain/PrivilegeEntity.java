...
/**
 * A database backed privilege implementation.
 * 
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
public class PrivilegeEntity implements Privilege
{
	 ...
	 */
	private static final long serialVersionUID = -7216220702174163263L;

	@Id
	@GeneratedValue
	@Column(name = "app_priv_id")
	private Long id;

	@Column(name = "app_priv_dsc")
	...
	public boolean equals(final Object object)
	{
		...
		final PrivilegeEntity that = (PrivilegeEntity) object;
