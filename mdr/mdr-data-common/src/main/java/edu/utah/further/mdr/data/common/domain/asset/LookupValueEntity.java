...
/**
 * A value in an ordered lookup group - persistent entity implementation.
 * <p>
 * -----------------------------------------------------------------------------------<br>
...
public class LookupValueEntity implements LookupValue
{
	// ========================= CONSTANTS =================================
	 ...
	 * Group label.
	 */
	@Column(name = "LOOKUP_VALUE_LABEL", length = 1000, nullable = true)
	 ...
	 */
	@Override
	public int compareTo(final LookupValue other)
	{
