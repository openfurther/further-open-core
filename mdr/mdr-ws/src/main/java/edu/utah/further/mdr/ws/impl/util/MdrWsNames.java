...
@Api
@Constants
public abstract class MdrWsNames
{
	 ...
	 */
	public static final String SOAP_SERVICE_PACKAGE = "edu.utah.further.mdr.ws.api.service.soap";

	/**
	 * Spring bean name of SOAP search/query service.
	 */
	public static final String SOAP_ASSET_SERVICE_SPRING_NAME = "mdrAssetService";

	/**
	 * Fully-qualified class name of SOAP search/query service interface.
	 */
	public static final String SOAP_ASSET_SERVICE_INTERFACE = SOAP_SERVICE_PACKAGE
			+ PROPERTY_SCOPE_CHAR + "AssetServiceSoap";
